---
title: "pg hardstorage show"
description: CLI reference for the pg hardstorage show command.
tags:
  - cli
  - reference
---
...
show prints the full manifest of a single backup —
...
```
pg_hardstorage show <deployment> <backup-id> [flags]
```
...
```
  -h, --help              help for show
      --include-deleted   surface tombstoned (soft-deleted) manifests too (body marked tombstoned=true with deleted_at/reason/policy)
