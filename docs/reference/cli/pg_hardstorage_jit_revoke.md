---
title: "pg hardstorage jit revoke"
description: CLI reference for the pg hardstorage jit revoke command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage jit revoke <token-id> [flags]
```

### Options

```
      --by string       operator identity recording the revocation
  -h, --help            help for revoke
      --reason string   revocation reason (recorded in the marker)
