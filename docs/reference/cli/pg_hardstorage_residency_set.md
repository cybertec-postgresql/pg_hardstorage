---
title: "pg hardstorage residency set"
description: CLI reference for the pg hardstorage residency set command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage residency set <deployment> <region> [<region> ...] [flags]
```
