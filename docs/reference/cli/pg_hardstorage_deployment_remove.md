---
title: "pg hardstorage deployment remove"
description: CLI reference for the pg hardstorage deployment remove command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage deployment remove <name> [flags]
```
