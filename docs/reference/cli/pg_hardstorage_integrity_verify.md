---
title: "pg hardstorage integrity verify"
description: CLI reference for the pg hardstorage integrity verify command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage integrity verify <id> [flags]
```
