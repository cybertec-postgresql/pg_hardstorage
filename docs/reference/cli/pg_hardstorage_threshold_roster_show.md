---
title: "pg hardstorage threshold roster show"
description: CLI reference for the pg hardstorage threshold roster show command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage threshold roster show <id> [flags]
```
