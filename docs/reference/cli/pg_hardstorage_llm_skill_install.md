---
title: "pg hardstorage llm skill install"
description: CLI reference for the pg hardstorage llm skill install command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage llm skill install <path> [flags]
```
