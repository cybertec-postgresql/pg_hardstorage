---
title: "pg hardstorage slo set"
description: CLI reference for the pg hardstorage slo set command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage slo set <deployment> [flags]
```
...
```
  -h, --help         help for set
      --rpo string   max acceptable backup lag (e.g. 1h, 30m, 24h, 7d)
      --rto string   max acceptable restore time (e.g. 10m, 1h)
```
