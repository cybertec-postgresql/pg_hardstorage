---
title: "pg hardstorage threshold attest verify"
description: CLI reference for the pg hardstorage threshold attest verify command.
tags:
  - cli
  - reference
---
...
Reads the attestation header + every per-member signature,
...
```
pg_hardstorage threshold attest verify <kind> <id> [flags]
```
