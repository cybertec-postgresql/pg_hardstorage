---
title: "pg hardstorage plugin list"
description: CLI reference for the pg hardstorage plugin list command.
tags:
  - cli
  - reference
---
...
Walks $HSPLUGIN_PATH (or the default plugin dirs), probes each
...
```
pg_hardstorage plugin list [flags]
```
