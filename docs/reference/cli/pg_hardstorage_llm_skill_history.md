---
title: "pg hardstorage llm skill history"
description: CLI reference for the pg hardstorage llm skill history command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage llm skill history <name> [flags]
```

### Options

```
      --dir string   override the install directory
