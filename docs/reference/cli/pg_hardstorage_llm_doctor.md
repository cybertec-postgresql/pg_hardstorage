---
title: "pg hardstorage llm doctor"
description: CLI reference for the pg hardstorage llm doctor command.
tags:
  - cli
  - reference
---
...
doctor verifies the LLM helper's plumbing end-to-end:
