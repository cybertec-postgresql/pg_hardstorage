---
title: "pg hardstorage slo report"
description: CLI reference for the pg hardstorage slo report command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage slo report [<deployment>] [flags]
```
...
```
  -h, --help          help for report
      --repo string   override the deployment's configured repo (optional)
```
