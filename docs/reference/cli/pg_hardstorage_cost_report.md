---
title: "pg hardstorage cost report"
description: CLI reference for the pg hardstorage cost report command.
tags:
  - cli
  - reference
---
...
Walk the repository and report bytes consumed by category, with
...
```
  -h, --help                       help for report
      --price-per-gb-month float   USD per GB per month (default: AWS S3 Standard us-east-1) (default 0.023)
