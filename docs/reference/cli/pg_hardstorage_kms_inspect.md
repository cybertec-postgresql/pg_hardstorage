---
title: "pg hardstorage kms inspect"
description: CLI reference for the pg hardstorage kms inspect command.
tags:
  - cli
  - reference
---
...
Reports presence, file mode, and (for the signing public key)
...
```
pg_hardstorage kms inspect [flags]
```
