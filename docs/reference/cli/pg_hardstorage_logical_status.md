---
title: "pg hardstorage logical status"
description: CLI reference for the pg hardstorage logical status command.
tags:
  - cli
  - reference
---
...
status walks the registry and (when --pg-connection is set)
...
```
pg_hardstorage logical status [<name>] [flags]
```
...
```
  -h, --help                   help for status
      --pg-connection string   libpq connection string (regular mode) — when set, surfaces lag info from pg_replication_slots
```
