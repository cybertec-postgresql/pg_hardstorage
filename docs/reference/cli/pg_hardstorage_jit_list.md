---
title: "pg hardstorage jit list"
description: CLI reference for the pg hardstorage jit list command.
tags:
  - cli
  - reference
---
...
```
  -h, --help               help for list
      ...
      --status string      filter by status: active | not_yet_active | expired | revoked
