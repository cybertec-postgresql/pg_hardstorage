---
title: "pg hardstorage llm history show"
description: CLI reference for the pg hardstorage llm history show command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage llm history show <session-id> [flags]
```
