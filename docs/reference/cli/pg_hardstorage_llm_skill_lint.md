---
title: "pg hardstorage llm skill lint"
description: CLI reference for the pg hardstorage llm skill lint command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage llm skill lint <path-or-name> [flags]
```
