---
title: "pg hardstorage repo bundle import"
description: CLI reference for the pg hardstorage repo bundle import command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage repo bundle import [flags]
```
...
```
  -h, --help        help for import
      --in string   input path to a .tar bundle (required)
      --to string   destination repository URL (required)
```
