---
title: "pg hardstorage repo scrub"
description: CLI reference for the pg hardstorage repo scrub command.
tags:
  - cli
  - reference
---
...
scrub samples N% of the repo's referenced chunks and re-hashes
...
```
pg_hardstorage repo scrub <url> [flags]
```
