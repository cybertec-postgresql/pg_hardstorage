---
title: "pg hardstorage threshold roster list"
description: CLI reference for the pg hardstorage threshold roster list command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage threshold roster list [flags]
```
