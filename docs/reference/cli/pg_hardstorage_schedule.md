---
title: "pg hardstorage schedule"
description: CLI reference for the pg hardstorage schedule command.
tags:
  - cli
  - reference
---
...
schedule configures and inspects per-deployment
...
```
pg_hardstorage schedule [<deployment> [<expression>]] [flags]
```
