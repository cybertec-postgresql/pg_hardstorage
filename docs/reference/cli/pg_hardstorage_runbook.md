---
title: "pg hardstorage runbook"
description: CLI reference for the pg hardstorage runbook command.
tags:
  - cli
  - reference
---
...
Each runbook is a step-by-step Markdown document with copy-pasteable
