---
title: "pg hardstorage kms hsm-status"
description: CLI reference for the pg hardstorage kms hsm-status command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage kms hsm-status [flags]
```

### Options

```
  -h, --help   help for hsm-status
```
