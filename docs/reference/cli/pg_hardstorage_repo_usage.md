---
title: "pg hardstorage repo usage"
description: CLI reference for the pg hardstorage repo usage command.
tags:
  - cli
  - reference
---
...
Walk the repository and report object count + bytes per category (chunks, manifests, WAL, trash, audit).

```
pg_hardstorage repo usage <url> [flags]
```
