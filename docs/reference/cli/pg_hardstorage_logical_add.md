---
title: "pg hardstorage logical add"
description: CLI reference for the pg hardstorage logical add command.
tags:
  - cli
  - reference
---
...
Append a stream to the registry. Does NOT create the slot or the
