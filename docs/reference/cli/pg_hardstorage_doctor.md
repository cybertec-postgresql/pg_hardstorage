---
title: "pg hardstorage doctor"
description: CLI reference for the pg hardstorage doctor command.
tags:
  - cli
  - reference
---
...
Reports resolved filesystem paths, configuration status, and health checks.

```
pg_hardstorage doctor [<deployment>] [flags]
```
