---
title: "pg hardstorage approval list"
description: CLI reference for the pg hardstorage approval list command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage approval list [flags]
```
...
```
  -h, --help            help for list
      --op string       filter by op
      --repo string     repository URL (required)
      --status string   filter by status: pending|approved|expired|revoked
