---
title: "pg hardstorage repo wipe"
description: CLI reference for the pg hardstorage repo wipe command.
tags:
  - cli
  - reference
---
...
Permanently delete every object in the named repository — every
...
```
pg_hardstorage repo wipe <url> [flags]
```
...
```
  ...
  -h, --help                      help for wipe
      ...
      --yes                       acknowledge that this op is irreversible (always required)
```
