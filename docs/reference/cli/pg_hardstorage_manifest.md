---
title: "pg hardstorage manifest"
description: CLI reference for the pg hardstorage manifest command.
tags:
  - cli
  - reference
---
...
Inspect the per-backup manifest — the JSON record (files, sizes,
