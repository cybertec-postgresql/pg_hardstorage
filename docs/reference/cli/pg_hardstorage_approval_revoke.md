---
title: "pg hardstorage approval revoke"
description: CLI reference for the pg hardstorage approval revoke command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage approval revoke <request-id> [flags]
```

### Options

```
      --by string       operator-readable revoker ID (lands in audit chain)
