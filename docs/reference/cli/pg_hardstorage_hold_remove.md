---
title: "pg hardstorage hold remove"
description: CLI reference for the pg hardstorage hold remove command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage hold remove <deployment> <backup-id> [flags]
```
...
```
  -h, --help          help for remove
      ...
      --yes           confirm removal (required — releasing a hold is auditable)
```
