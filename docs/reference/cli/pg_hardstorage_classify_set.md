---
title: "pg hardstorage classify set"
description: CLI reference for the pg hardstorage classify set command.
tags:
  - cli
  - reference
---
...
Sets the classification of <deployment> to <level>. Allowed
...
```
pg_hardstorage classify set <deployment> <level> [flags]
```
