---
title: "pg hardstorage approval status"
description: CLI reference for the pg hardstorage approval status command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage approval status <request-id> [flags]
```
