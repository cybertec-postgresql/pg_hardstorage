---
title: "pg hardstorage wal preflight"
description: CLI reference for the pg hardstorage wal preflight command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage wal preflight <deployment> [flags]
```
...
```
  -h, --help                   help for preflight
      ...
      --role user=             role the streamer connects as; if empty, the role is inferred from --pg-connection (user= parameter)
```
