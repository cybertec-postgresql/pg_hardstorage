---
title: "pg hardstorage patroni status"
description: CLI reference for the pg hardstorage patroni status command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage patroni status [flags]
```
...
```
  -h, --help              help for status
      ...
      --url string        Patroni REST base URL (e.g. http://patroni-leader:8008) — required
