---
title: "pg hardstorage audit anchor"
description: CLI reference for the pg hardstorage audit anchor command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage audit anchor [flags]
```
...
```
  -h, --help               help for anchor
      --publisher string   opaque label for who anchored (e.g. control-plane node ID)
