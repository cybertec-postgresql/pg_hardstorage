---
title: "pg hardstorage timetravel destroy"
description: CLI reference for the pg hardstorage timetravel destroy command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage timetravel destroy <name> [flags]
```
