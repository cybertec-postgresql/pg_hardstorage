---
title: "pg hardstorage residency check"
description: CLI reference for the pg hardstorage residency check command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage residency check <deployment> [flags]
```
