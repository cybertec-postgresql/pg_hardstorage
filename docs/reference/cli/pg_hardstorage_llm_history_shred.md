---
title: "pg hardstorage llm history shred"
description: CLI reference for the pg hardstorage llm history shred command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage llm history shred [flags]
```
