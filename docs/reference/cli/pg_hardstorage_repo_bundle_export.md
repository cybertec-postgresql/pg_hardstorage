---
title: "pg hardstorage repo bundle export"
description: CLI reference for the pg hardstorage repo bundle export command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage repo bundle export [flags]
```
