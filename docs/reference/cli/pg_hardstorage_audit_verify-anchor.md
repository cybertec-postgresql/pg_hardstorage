---
title: "pg hardstorage audit verify-anchor"
description: CLI reference for the pg hardstorage audit verify-anchor command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage audit verify-anchor <log-id> [flags]
```

### Options

```
  -h, --help          help for verify-anchor
