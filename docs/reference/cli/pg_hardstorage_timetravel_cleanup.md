---
title: "pg hardstorage timetravel cleanup"
description: CLI reference for the pg hardstorage timetravel cleanup command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage timetravel cleanup [flags]
```
...
```
  -h, --help             help for cleanup
      --remove-targets   also rm -rf each reaped session's data dir
```
