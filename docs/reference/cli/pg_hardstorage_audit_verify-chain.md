---
title: "pg hardstorage audit verify-chain"
description: CLI reference for the pg hardstorage audit verify-chain command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage audit verify-chain [flags]
```

### Options

```
  -h, --help          help for verify-chain
