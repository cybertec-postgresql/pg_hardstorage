---
title: "pg hardstorage residency clear"
description: CLI reference for the pg hardstorage residency clear command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage residency clear <deployment> [flags]
```
