---
title: "pg hardstorage classify"
description: CLI reference for the pg hardstorage classify command.
tags:
  - cli
  - reference
---
...
Tag deployments with a data-sensitivity level. Levels (least to
