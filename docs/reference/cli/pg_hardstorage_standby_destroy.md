---
title: "pg hardstorage standby destroy"
description: CLI reference for the pg hardstorage standby destroy command.
tags:
  - cli
  - reference
---
...
```
pg_hardstorage standby destroy <name> [flags]
```
...
```
  -h, --help            help for destroy
      --remove-target   also rm -rf the data directory
```
