...
```sh
VERSION=1.0.6   # latest release: https://github.com/cybertec-postgresql/pg_hardstorage/releases/latest
...
```sh
VERSION=1.0.6   # the release you downloaded
...
```sh
VERSION=1.0.6   # latest release tag
...
```sh
$ pg_hardstorage version
pg_hardstorage v1.0.6 (abc1234, built 2026-04-29T12:00:00Z)
```
